...
#'
#' @param aoa An R object of class \code{aoa} (generated by the \code{\link{aoa}} function) containing:
#'  \item{parameters}{object of class trainDI. see \code{\link{trainDI}}}
#'  \item{DI}{\code{SpatRaster}, \code{stars} object or \code{data frame}. Dissimilarity index of newdata}
#'  \item{AOA}{\code{SpatRaster}, \code{stars} object or \code{data frame}. Area of Applicability of newdata.}
#'  \item{LPD}{\code{SpatRaster}, \code{stars} object or \code{data frame}. Local data point density of newdata.}
#'
#' @details
